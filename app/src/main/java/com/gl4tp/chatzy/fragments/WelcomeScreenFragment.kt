...
class WelcomeScreenFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val continueBtn = view.findViewById<Button>(R.id.button).apply{
            startAnimation(
                AnimationUtils.loadAnimation(view.context,R.anim.zoom_in_cut)
            )
        }
        continueBtn.setOnClickListener{
            val action = WelcomeScreenFragmentDirections.actionWelcomeScreenFragmentToRobotListScreenFragment()
